...
* `./console visitorgenerator:generate-visits --idsite 5 --with-malicious-payloads --limit-malicious-visits=40` generates additional visits where fields are filled with SQLi/XSS/template-style payloads
